...
class EpiMaxLoss(nn.Module):
    ...
    def __init__(self, alpha=5.5, beta=2.7, gamma=3.8):    
...
def run_experiment():
    ...
    fig_inputs, axes_inputs = plt.subplots(1, 4, figsize=(14, 4))
    
    axes_inputs[0].imshow(denormalize(img_8), cmap='gray')
    axes_inputs[0].set_title("Clear digit '8'", fontsize=19)
    axes_inputs[0].axis('off')
    
    axes_inputs[1].imshow(denormalize(img_3), cmap='gray')
    axes_inputs[1].set_title("Clear digit '3'", fontsize=19)
    axes_inputs[1].axis('off')
    
    axes_inputs[2].imshow(denormalize(img_ambiguous), cmap='gray')
    axes_inputs[2].set_title("Ambiguous '3' vs '8'", fontsize=19)
    axes_inputs[2].axis('off')
    
    axes_inputs[3].imshow(denormalize(img_shoe), cmap='gray')
